...
/// Shared text styles and legacy color constants. Board chrome colors now
/// come from [AppTheme] via [ThemeController].
abstract class Styling {
  // **** GRADIENTS AND COLORS (classic defaults; prefer AppTheme) ****
